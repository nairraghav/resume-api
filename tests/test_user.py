...
def test_create_user():
    new_experience = experience.Experience(company_name="Company", start_date="01-01-2019", end_date="01-02-2019",
                                           description="This was my job")
    new_user = user.User(password="password", test_pass="password", email_address="ron@ron.com", phone_number="123456789", city_state="Seattle, WA", last_name="Ronaldo", first_name="Ron", experiences=[new_experience])
